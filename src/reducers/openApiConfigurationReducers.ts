...
import { LOAD_OPEN_API_CONFIGURATION_REQUEST, LOAD_OPEN_API_CONFIGURATION_SUCCESS, LOAD_OPEN_API_CONFIGURATION_ERROR } from '../actions/actionsTypes'
...
export default (state: OpenApiStore = undefined, action: OpenApiConfigurationsActionTypes) => {
    ...
    switch(action.type){
        case LOAD_OPEN_API_CONFIGURATION_REQUEST: return Object.assign({}, state, { status: Status.Requested })
